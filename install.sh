...
pre_install_docker_compose(){
    ...
    read -p "(image address (Default salemlu/v2ray_v3:go_pay):" docker_addresss
    [ -z "${docker_addresss}" ] && docker_addresss="salemlu/v2ray_v3:go_pay"
    echo
    echo "---------------------------"
...
pre_install_caddy(){
    ...
    [ -z "${v2ray_email}" ]  && v2ray_email="lusalem@yandex.com"
    echo
    echo "---------------------------"
